                    ...
                    <div class="row mb-2">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" id="project_name" name="project_name" class="form form-control" value="{{ old('project_name') }}"/>
                            </div>
                            @error('project_name')
                    ...
                    <div class="row mb-2">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="date" id="due_date" name="due_date" class="form form-control" value="{{ old('due_date') }}" />
                            </div>
                            @error('due_date')
                            <span class="text-danger"> {{ $message }}</span>
                            @enderror
